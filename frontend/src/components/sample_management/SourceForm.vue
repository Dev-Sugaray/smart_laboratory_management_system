<template>
  <div class="box source-form">
    <h3 class="subtitle">{{ formTitle }}</h3>
    <form @submit.prevent="handleSubmit">
      <div class="field">
        <label for="source-name" class="label">Name</label>
        <div class="control">
          <input
            type="text"
            id="source-name"
      ...
      <div class="field">
        <label for="source-desc" class="label">Description</label>
        <div class="control">
          <textarea
            id="source-desc"
            class="textarea"
...
const formTitle = computed(() => {
  return props.isEditMode ? 'Edit Source' : 'Add New Source';
});
